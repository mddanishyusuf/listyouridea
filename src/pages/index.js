...
import { AppsListDetail24Filled, BoxMinimalisticOutline, ChatSquareOutline, EyeLinear, HeartOutline, LinkSquare02, MailOpen, RepeatLinear } from '@/lib/icons';
                    ...
                    <main className="main-content">
                        <div className="hero-section">
                            <div className="hero-text">
                                ...
                                <h1 className="hero-title">Fresh new ideas and products, every week</h1>
                                ...
                                <div className="content-head">
                                    ...
                                    <div>
                                        <div className="product-description">
                                            <span style={{ color: '#ededed', fontWeight: 500 }}>{p.productTitle}</span> — {p.productDescription}
                                        </div>
                                        {p.publishedAt && (
